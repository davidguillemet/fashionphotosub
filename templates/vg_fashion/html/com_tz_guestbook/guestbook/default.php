...
var fullNameLabel = "<?php echo JText::_("COM_TZ_GUESTBOOK_FULL_NAME"); ?>";
var eMailLabel = "<?php echo JText::_("COM_TZ_GUESTBOOK_EMAIL"); ?>";
var commentTitleLabel = "<?php echo JText::_("COM_TZ_GUESTBOOK_TITLE"); ?>";
var webSiteLabel = "<?php echo JText::_("COM_TZ_GUESTBOOK_WEBSITE"); ?>";
var commentLabel = "<?php echo JText::_("COM_TZ_GUESTBOOK_YOUR_GUESTBOOK"); ?>";
...
jQuery(document).ready(function () {
    ...
    jQuery('#warp-input1').focus(function () {
        ...
        if (inpName == fullNameLabel || inpName == "") {
        ...
        if (inpName != "") {
            jQuery('#warp-input1').keyup(function () {
                ...
                if (HieuName > 0) {
                    pp.innerHTML = "<?php echo JText::_("COM_TZ_GUESTBOOK_COUNT_TEXT_NAME"); ?>".replace("{0}", HieuName);
                } else {
    ...
    jQuery('#warp-input1').blur(function () {
        ...
        if (inpName == "") {
            document.getElementById("warp-input1").value = fullNameLabel;
        }
    }); // end full name
    ...
    jQuery('#warp-input2').focus(function () {
        ...
        if (inpEmail == eMailLabel || inpEmail == "") {
        ...
        if (inpEmail != "") {
            jQuery('#warp-input2').keyup(function () {
                ...
                if (HieuName > 0) {
                    ppemail.innerHTML = "<?php echo JText::_("COM_TZ_GUESTBOOK_COUNT_TEXT_EMAIL"); ?>".replace("{0}", HieuName);
                } else {
    ...
    jQuery('#warp-input3').focus(function () {
        ...
        if (inpTitle == commentTitleLabel || inpTitle == "") {
        ...
        if (inpTitle != "") {
            jQuery('#warp-input3').keyup(function () {
                ...
                if (HieuName > 0) {
                    pptitle.innerHTML = "<?php echo JText::_("COM_TZ_GUESTBOOK_COUNT_TEXT_TITLE"); ?>".replace("{0}", HieuName);
                } else {
    ...
    jQuery('#warp-input4').focus(function () {
        ...
        if (inpWeb != "") {
            jQuery('#warp-input4').keyup(function () {
                ...
                if (HieuName > 0) {
                    ppweb.innerHTML = "<?php echo JText::_("COM_TZ_GUESTBOOK_COUNT_TEXT_WEBSITE"); ?>".replace("{0}", HieuName);
                } else {
    ...
    jQuery('#warp-input-sub').click(function () {
        ...
        if (subtitle == "") {
            ...
            errotitle.focus();
            return false;
        } else if (subtitle == commentTitleLabel) {
            jQuery(".tz_input_title").css("display", "block");
        ...
        if (subcontent == "") {
            ...
            errocontent.focus();
            return false;
        } else if (subcontent == commentLabel) {
            jQuery(".tz_input_comment").css("display", "block");
