...
<div class="TzItemPage item-page<?php echo $this->pageclass_sfx?>">
    <div class="TzItemPageInner">
        ...
        <?php endif; ?>
            ...
            <?php if ($params->get('show_create_date',1)) : ?>
                <span class="TzCreate">
                    <span class="date"> <?php echo JText::sprintf(date("M j, Y", strtotime($this->item->created))); ?></span>
                </span>
            <?php endif; ?>
    ...
    <?php if ($params->get('access-view')):?>
        ...
        <?php endif;?>
        <?php if ($params->get('show_modify_date',1) or $params->get('show_hits',1)) : ?>
        ...
        <?php
            require_once(JPATH_BASE.DIRECTORY_SEPARATOR.'templates'.DIRECTORY_SEPARATOR.$template.DIRECTORY_SEPARATOR.'html'.DIRECTORY_SEPARATOR.'com_tz_portfolio'.DIRECTORY_SEPARATOR.'users'.DIRECTORY_SEPARATOR.'default_author.php');
        ?>
