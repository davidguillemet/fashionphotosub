  ...
  <script type="text/javascript">
        ...
        tz(function(){
            ...
            $container.infinitescroll({
                ...
                loading: {
                    msgText:'<?php echo JText::_('COM_TZ_PORTFOLIO_LOADING_TEXT_TPL');?>',
                    finishedMsg: '',
                                ...
                                if (data.length) {
                                    ...
                                    tztag.each(function(){
                                        if(jQuery(this).attr('data-option-value')){
                                            jQuery('#tz_append').addClass(jQuery(this).attr('data-option-value').replace('.',''));
                                        }
                                    });
                                    loadPortfolio();
