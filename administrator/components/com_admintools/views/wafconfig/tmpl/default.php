...
<?php if (!$this->longConfig): ?>
	<ul class="nav nav-tabs" id="wafTabs">
		...
		<li><a href="#activeFiltering"
			   data-toggle="tab"><?php echo JText::_('ATOOLS_LBL_WAF_OPTGROUP_ACTIVEFILTERING') ?></a></li>
		<li><a href="#jhardening" data-toggle="tab"><?php echo JText::_('ATOOLS_LBL_WAF_OPTGROUP_JHARDENING') ?></a>
		</li>
		<li><a href="#fingerprinting"
			   data-toggle="tab"><?php echo JText::_('ATOOLS_LBL_WAF_OPTGROUP_FINGERPRINTING') ?></a></li>
		<li><a href="#honeypot" data-toggle="tab"><?php echo JText::_('ATOOLS_LBL_WAF_LBL_PROJECTHONEYPOT') ?></a></li>
		<li><a href="#exceptions" data-toggle="tab"><?php echo JText::_('ATOOLS_LBL_WAF_OPTGROUP_EXCEPTIONS') ?></a>
		</li>
		<li><a href="#tsr" data-toggle="tab"><?php echo JText::_('ATOOLS_LBL_WAF_LBL_TSR') ?></a></li>
		<li><a href="#loggingReporting"
			   data-toggle="tab"><?php echo JText::_('ATOOLS_LBL_WAF_OPTGROUP_LOGGINGANDREPORTING') ?></a></li>
		<li><a href="#custommessage" data-toggle="tab"><?php echo JText::_('ATOOLS_LBL_WAF_CUSTOMMESSAGE_HEADER') ?></a>
		</li>
	</ul>
<?php endif; ?>
...
<div class="tab-pane" id="jhardening">
	...
	<div class="control-group">
		<label class="control-label"
			   for="blockinstall"
			   rel="popover"
			   data-original-title="<?php echo JText::_('ATOOLS_LBL_WAF_OPT_BLOCKINSTALL'); ?>"
			   data-content="<?php echo JText::_('ATOOLS_LBL_WAF_OPT_BLOCKINSTALL_TIP'); ?>">
		<?php echo JText::_('ATOOLS_LBL_WAF_OPT_BLOCKINSTALL'); ?>
		</label>
