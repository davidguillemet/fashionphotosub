...
class Sh404sefClassConfig
{
	...
	// 4.5
	public $extensionToExtractGetVars = 'com_chronoforums';
	...
	public function __construct($reset = false)
	{
		...
		else
		{
			...
			{ // only need to modify custom params in back-end
			    ...
			    // 4.4.6.2271 - anything-digital.com/sh404sef/seo-analytics-and-security-for-joomla.html
