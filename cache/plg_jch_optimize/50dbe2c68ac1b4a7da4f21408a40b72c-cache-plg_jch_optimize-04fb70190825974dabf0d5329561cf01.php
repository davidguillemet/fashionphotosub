<?php die("Access Denied"); ?>#x#a:2:{s:6:"output";s:0:"";s:6:"result";s:5660:"@font-face {
  font-family: 'fontello';
  src: url(/fashion/templates/vg_fashion/font/fontello.eot);
  src: url(/fashion/templates/vg_fashion/font/fontello.eot) format('embedded-opentype'),
       url(/fashion/templates/vg_fashion/font/fontello.woff) format('woff'),
       url(/fashion/templates/vg_fashion/font/fontello.ttf) format('truetype'),
       url(/fashion/templates/vg_fashion/font/fontello.svg) format('svg');
  font-weight: normal;
  font-style: normal;
}
...
@media screen and (-webkit-min-device-pixel-ratio:0) {
  @font-face {
    font-family: 'fontello';
    src: url('../font/fontello.svg?28732634#fontello') format('svg');
  }
}
*/
...
.icon-sliders:before { content: '\e81c'; } /* '' */
...
.icon-target:before { content: '\e825'; } /* '' */
...
.icon-emo-beer:before { content: '\e82b'; } /* '' */
.icon-emo-displeased:before { content: '\e82c'; } /* '' */
...
.icon-angle-circled-down:before { content: '\e835'; } /* '' */
.icon-angle-double-down:before { content: '\e836'; } /* '' */
.icon-down-circled:before { content: '\e837'; } /* '' */
.icon-expand:before { content: '\e838'; } /* '' */
...
.icon-th-large:before { content: '\e840'; } /* '' */
