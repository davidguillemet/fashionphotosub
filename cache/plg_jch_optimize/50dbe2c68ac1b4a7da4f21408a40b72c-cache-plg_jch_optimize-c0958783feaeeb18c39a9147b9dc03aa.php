<?php die("Access Denied"); ?>#x#a:2:{s:6:"output";s:0:"";s:6:"result";s:33565:"@import url(https://fonts.googleapis.com/css?family=Open Sans:400&subset=Latin);
...
#search-form103 input::-ms-clear{
  width: 0;
  height: 0;
}

#search-form103 input::focus {
  outline: none;
}
...
#offlajn-ajax-search103 .offlajn-ajax-search-container{
  padding: 0;
  margin:0;
}

#offlajn-ajax-search103 .offlajn-ajax-search-container.active{
  border-radius: 0;
}

#offlajn-ajax-search103 .offlajn-ajax-search-inner{
  width:100%;
}
...
.dj_ie #search-form103 input{
  padding-top:0px;
}

.dj_ie7 #search-form103{
  padding-bottom:0px;
}

#search-form103 .category-chooser{
  height: 24px;
...
#search-form103 .category-chooser:hover{
...
#search-form103 .category-chooser.opened{
  border-bottom: none;
  -moz-border-radius-bottomleft: 0px;
  border-bottom-left-radius: 0px;
}

#search-form103 .category-chooser.opened .arrow{
...
#search-form103 .category-chooser .arrow{
  height: 100%;
  width: 24px;
  background: no-repeat center center;
  background-image: url(/fashion/modules/mod_universal_ajaxlivesearch/themes/flat/images/arrow/settings.png);
  background-size: auto 100%;
  border:none;
/*  border-right: 1px solid rgba(255, 255, 255, 0.6);*/
}

.dj_ie7 #search-form103 .category-chooser .arrow,
.dj_ie8 #search-form103 .category-chooser .arrow{
  background-image: url(/fashion/modules/mod_universal_ajaxlivesearch/themes/flat/images//ie_old/settings_old.png);
}
...
input#suggestion-area103{
  ...
  background: url(/fashion/modules/mod_universal_ajaxlivesearch/cache/103/98342bc89c215513144c1d4851e67a4e.png)  ;background: rgba(0, 0, 0, 0.6);  
  border: none;
  z-index:1;  
...
.dj_ie7 input#suggestion-area103{
  float: right;
  left:1px;
  top:1px;
  border:none;
...
#search-form103 #search-area-close103.search-area-loading{
  background: url(/fashion/modules/mod_universal_ajaxlivesearch/themes/flat/images/loaders/loader.png) no-repeat center center;
  background-size: auto 100%;
  animation: loader 1s infinite linear;
  -webkit-animation: loader 1s infinite linear;
}

#search-form103 #search-area-close103{
    background: url(/fashion/modules/mod_universal_ajaxlivesearch/themes/flat/images/close/close.png) no-repeat center center;
    background-size: auto 100%;
  height: 28px;
  width: 28px;
  top:50%;
...
.dj_ie7 #search-form103 #search-area-close103,
.dj_ie8 #search-form103 #search-area-close103{
    background: url(/fashion/modules/mod_universal_ajaxlivesearch/themes/flat/images/ie_old/close_old.png) no-repeat center center;
  }

#ajax-search-button103{
  height: 100%;
  width: 30px;
  padding: 0 5px;
...
.dj_ie7 #ajax-search-button103{
  top: 0+1; ?>px;
  right: 0-1; ?>px;
}

.dj_opera #ajax-search-button103{
  border-radius: 0;
}

#ajax-search-button103 .magnifier{
    background: url(/fashion/modules/mod_universal_ajaxlivesearch/themes/flat/images/search_button/magnifier.png) no-repeat center center;
    background-size: 100%;
  height: 27px;
  width: 30px;
  padding:0;
...
.dj_ie7 #ajax-search-button103 .magnifier,
.dj_ie8 #ajax-search-button103 .magnifier{
    background: url(/fashion/modules/mod_universal_ajaxlivesearch/themes/flat/images/ie_old/magnifier_old.png) no-repeat center center;
  }
...
#offlajn-ajax-tile-results .offlajn-ajax-search-control-panel{
  min-height: 38px;
  border: none;
  background: url(/fashion/modules/mod_universal_ajaxlivesearch/cache/103/98342bc89c215513144c1d4851e67a4e.png)  ;background: rgba(0, 0, 0, 0.6);  -webkit-touch-callout: none;
  -webkit-user-select: none;
  -khtml-user-select: none;
  -moz-user-select: none;
  -ms-user-select: none;
...
#offlajn-ajax-tile-results .offlajn-ajax-search-control-panel .inner-control-panel .offlajn-button:hover{
  background: url(/fashion/modules/mod_universal_ajaxlivesearch/cache/103/4ccf31917fdb75ec3e3e008318e21d55.png)  ;background: rgba(255, 255, 255, 0.1);}
...
#offlajn-ajax-tile-results .search-result-card .search-result-content{
  ...
  position: absolute;
  width: 100%;
  background: url(/fashion/modules/mod_universal_ajaxlivesearch/cache/103/98342bc89c215513144c1d4851e67a4e.png)  ;background: rgba(0, 0, 0, 0.6);  padding:5px;
...
#offlajn-ajax-tile-results .search-result-link .search-result-card .search-result-beacon .beaconCircle1{
  ...
  background: url(/fashion/modules/mod_universal_ajaxlivesearch/cache/103/3aed0a590fbd2cf07f99a31d8cc8b8ee.png)  ;background: rgba(0, 0, 0, 0.4);  -moz-transition: all 300ms cubic-bezier(0.230, 1.000, 0.320, 1.000);
...
#offlajn-ajax-tile-results .search-result-link .search-result-card .search-result-beacon .beaconCircle2{
  ...
  width: 75%;
  height: 75%;
  background: url(/fashion/modules/mod_universal_ajaxlivesearch/cache/103/e4291593a18bd4db411478bb1fd9b689.png)  ;background: rgba(0, 0, 0, 0.7);  
...
#offlajn-ajax-tile-results .search-result-link .search-result-card.clicked .search-result-beacon .imgbeacon{
  animation: loader 1s infinite linear;
  -webkit-animation: loader 1s infinite linear;
  background-image: url(/fashion/modules/mod_universal_ajaxlivesearch/themes/flat/images/loaders/loader.png);
}
...
#offlajn-ajax-tile-results .search-result-card .search-result-price{
  ...
  line-height: 32px;
  /*font chooser*/
  background: url(/fashion/modules/mod_universal_ajaxlivesearch/cache/103/98342bc89c215513144c1d4851e67a4e.png)  ;background: rgba(0, 0, 0, 0.6);  -webkit-transition:all 0.3s;
  -moz-transition:all 0.3s;
  transition:all 0.3s;  
  -moz-transform: translate3d(0,0,0);
  -webkit-transform: translate3d(0,0,0);
...
#offlajn-ajax-tile-results #no-result-message{
  ...
  border-radius: 0;
  display: block;
  background: url(/fashion/modules/mod_universal_ajaxlivesearch/cache/103/98342bc89c215513144c1d4851e67a4e.png)  ;background: rgba(0, 0, 0, 0.6);  -webkit-transition: all 0.15s ease-out 0s; 
...
#offlajn-ajax-tile-results div.no-result-suggest{
  ...
  background: url(/fashion/modules/mod_universal_ajaxlivesearch/cache/103/98342bc89c215513144c1d4851e67a4e.png)  ;background: rgba(0, 0, 0, 0.6);  border: none;
...
#offlajn-ajax-tile-results div.no-result-suggest:after{
  ...
  height: 26px;
  left:0;
  background: url(/fashion/modules/mod_universal_ajaxlivesearch/themes/flat/images/tags/link.png) no-repeat left center;
  background-size: auto 100%;  
}
...
#search-categories103{
  border-radius: 0px;
  background: url(/fashion/modules/mod_universal_ajaxlivesearch/cache/103/16a22079d00680915c9aed8f42985c7e.png)  ;background: rgba(0, 0, 0, 0.91);  padding: 4px 10px;
  position: absolute;
  top:0px;
  left:0px;
  visibility: hidden;
...
#search-categories103 .search-categories-inner div{
  ...
  background: url(/fashion/modules/mod_universal_ajaxlivesearch/themes/flat/images/selections/unselected.png) no-repeat left center;
...
.dj_ie7 #search-categories103 .search-categories-inner div,
.dj_ie8 #search-categories103 .search-categories-inner div{
  background: url(/fashion/modules/mod_universal_ajaxlivesearch/themes/flat/images/ie_old/unselected_old.png) no-repeat left center;
}
  
#search-categories103 .search-categories-inner div.last{
  border:none;
}

#search-categories103 .search-categories-inner div.selected{
  background: url(/fashion/modules/mod_universal_ajaxlivesearch/themes/flat/images/selections/selected.png) no-repeat left center;
  background-size: auto 90%;  
}

.dj_ie7 #search-categories103 .search-categories-inner div.selected,
.dj_ie8 #search-categories103 .search-categories-inner div.selected{
  background: url(/fashion/modules/mod_universal_ajaxlivesearch/themes/flat/images/ie_old/selected_old.png) no-repeat left center;
}


#search-categories103 .search-categories-inner div:hover{
